...
![<https://docs.tibco.com/pub/spotfire/6.5.2/doc/html/images/cross_example_table.png>](cross_example_table.png)

![<https://docs.tibco.com/pub/spotfire/6.5.2/doc/html/images/cross_example_cross_table.png>](cross_example_cross_table.png)
...
![<https://libapps.s3.amazonaws.com/customers/836/qu/e1d262992c7ea1e2aa109305faf24d59.png>](apa.png)
...
![[https://gt.rstudio.com/reference/figures/gt_parts_of_a\\\\\\\_table.svg](https://gt.rstudio.com/reference/figures/gt_parts_of_a_table.svg){.uri}](gt_parts_of_a_table.svg)
...
![<https://gt.rstudio.com/reference/figures/gt_workflow_diagram.svg>](gt_workflow_diagram.svg)
...
매개변수 없이 `gt()`만으로도 `gt` 객체가 생성된다. 하지만 행을 그루핑하여 행 그룹으로 사용할 `groupname_col`과 표의 스텁(Stub)으로 사용할 열인 `rowname_col`을 설정해주면 표의 전반적인 기본 형태를 볼 수 있기 때문에 가급적이면 `gt` 객체를 생성할 때 설정해 주는 것이 좋다.
