...
![그림 II-3. 파이썬 plotly 다운로드](D:/R/git/datavisualization/plotly/chap2/python_download.png)
...
`plotly`를 사용하기 위해서는 먼저 R과 python에 `plolty` 패키지와 라이브러리를 설치하여야 한다. 

-   R

R에서 `plotly`는 이미 공식 CRAN에 등록되어 있기 때문에 `install.packages()`를 사용하여 설치할 수 있다. 설치한 이후 R에서 'plotly'를 사용하기 위해서는 먼저 `library()`나 `require()`로 `plotly` 패키지를 로딩하고 사용할 수 있다. 다음과 같이 패키지를 설치하고 로딩할 수 있다. 
...
python에서 `plotly`를 설치하기 위해서는 `pip`를 다음과 같이 실행하여 설치한다. 
...
`plotly` 패키지는 자체적으로 실행가능한 HTML 파일과 시각화를 작성하는 데 필요한 많은 것이 포함되어 있다.
...
```{r fig.cap = 'R의 plot_ly()를 사용한 초기화'}
## R에서 plotly 객체 초기화
...
![그림 II-1p. python의 Figure()를 사용한 초기화](init_P.png)
...
![그림 II-2p. python의 Figure()를 사용한 data 속성 설정](data_p.png)
...
![그림 II-3p. python의 layout 속성설정](D:/R/git/datavisualization/plotly/chap2/layout_p.png)
...
![그림 II-4p. python의 트레이스 생성](4_P.png)
...
![그림 II-5p. python의 x, y 속성 설정](xy_p.png)
...
```{r echo = FALSE, fig.cap = 'R의 name 속성 설정'}
df_취업률_500 |>
  ## X축은 졸업자수, Y축은 취업자수, name은 대계열로 매핑한 plotly 객체 생성
...
```
![그림 II-5p. python의 name 속성 설정](D:/R/git/datavisualization/plotly/chap2/name_p.png)
...
![그림 II-6p. python의 text 속성 설정](D:/R/git/datavisualization/plotly/chap2/text_p.png)
...
![그림 II-7p. python의 textposition 속성 설정](D:/R/git/datavisualization/plotly/chap2/textposition_p.png)
...
![그림 II-8p. python의 texttemplate 속성 설정](texttemplate_p.png)
...
![R의 hoverinfo 속성 설정](D:/R/git/datavisualization/plotly/chap2/hoverinfo_R.png)
...
![그림 II-9p. python의 hoverinfo 속성 설정](D:/R/git/datavisualization/plotly/chap2/hoverinfo.png)
...
![R의 hovertext 속성 설정](D:/R/git/datavisualization/plotly/chap2/hovertext_R.png)
...
![그림 II-10p. python의 hovertext 속성 설정](D:/R/git/datavisualization/plotly/chap2/hovertext.png)
...
![R의 hovertemplate 속성 설정](D:/R/git/datavisualization/plotly/chap2/hovertemplate_R.png)
...
![그림 II-11p. python의 hovertemplate 속성 설정](D:/R/git/datavisualization/plotly/chap2/hovertemplate.png)
...
![그림 II-12p. python의 opacity 속성 설정](D:/R/git/datavisualization/plotly/chap2/opacity_python.png)
...
![그림 II-13p. python의 showlegend 속성 설정](D:/R/git/datavisualization/plotly/chap2/showlegend_p.png)
...
![그림 II-14p. python의 Figure()를 사용한 title 설정](layout_title_p1.png)
...
![그림 II-15p. python의 update_layout()을 사용한 title 속성 설정](layout_title_p2.png)
...
![그림 II-16p. python의 HTML inline title 속성 설정](layout_title_p3.png)
...
![그림 II-17p. python의 color 속성 설정](layout_color_p1.png)
...
![그림 II-18p. python의 axis title, zeroline, grid 속성 설정](layout_axis_p1.png)
...
![그림 II-19p. python의 눈금라벨, 눈금 간격 속성 설정](layout_axis_p2.png)
...
![그림 II-20p. python의 축 범위 속성 설정](layout_axis_p3.png)
...
![그림 II-21p. python의 범례 설정](layout_legend_p1.png)
...
![그림 II-22p. python의 여백 설정](layout_margin_p1.png)
...
![그림 II-23p. python의 플롯 크기 속성 설정](layout_size_p1.png)
...
![그림 II-24p. python의 폰트 설정](layout_font_p.png)
...
![그림 II-25p. python의 서브 플롯 생성](subplot_p1.png)
...
![그림 II-26p. python의 서브 플롯 범례 설정](subplot_p2.png)
...
![그림 II-27p. python의 서브 플롯의 크기와 배치 설정](subplot_p3.png)
...
![그림 II-28p. plotly의 spec을 사용한 서브 플롯의 크기와 배치 설정](subplot_p4.png)
...
![그림 II-29p. python의 축 공유가 설정된 서브 플롯](subplot_p5.png)
...
![그림 II-8. 박스 trace의 정보 표시](D:/R/git/datavisualization/plotly/chap3/ployly_3_2.png)
...
![그림 II-9. 마우스 드래그를 통한 줌](D:/R/git/datavisualization/plotly/chap3/ployly_3_3.png)
