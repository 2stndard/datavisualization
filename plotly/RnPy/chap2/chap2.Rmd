...
![그림 II-3. R의 plotly 다운로드](download_r.png)
...
![그림 II-4. python plotly 다운로드](python_download.png)
...
![그림 II-5. R 샘플 코드의 data 속성 트리 구조](data_tree_R.png)
...
![그림 II-6. python 샘플 코드의 data 속성 트리 구조](data_tree_P.png)
