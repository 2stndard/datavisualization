...
df_covid19_100 |> 
  plot_ly() |>
  config(toImageButtonOptions = list(format = 'svg', filename = 'D:/R/git/datavisualization/plotly/RnPy/chap2/R_svg/2-1'))
...
df_covid19_100 |> 
  ...
  config(toImageButtonOptions = list(format = 'svg', filename = 'D:/R/git/datavisualization/plotly/RnPy/chap2/R_svg/2-2'))
...
df_covid19_100 |> 
  ...
  config(toImageButtonOptions = list(format = 'svg', filename = 'D:/R/git/datavisualization/plotly/RnPy/chap2/R_svg/2-3'))
...
df_취업률_500 |> 
  ...
  config(toImageButtonOptions = list(format = 'svg', filename = 'D:/R/git/datavisualization/plotly/RnPy/chap2/R_svg/2-4'))
...
df_취업률_500 |> 
  ...
  add_trace(type = 'scatter', mode = 'markers', 
            x = ~졸업자수, y = ~취업자수) |>
  config(toImageButtonOptions = list(format = 'svg', filename = 'D:/R/git/datavisualization/plotly/RnPy/chap2/R_svg/2-5'))
...
df_취업률_500 |>
  ...
  config(toImageButtonOptions = list(format = 'svg', filename = 'D:/R/git/datavisualization/plotly/RnPy/chap2/R_svg/2-6'))
...
df_covid19_100 |>
  ...
  config(toImageButtonOptions = list(format = 'svg', filename = 'D:/R/git/datavisualization/plotly/RnPy/chap2/R_svg/2-7'))
...
subplot(
  ...
  config(toImageButtonOptions = list(format = 'svg', filename = 'D:/R/git/datavisualization/plotly/RnPy/chap2/R_svg/2-8'))
...
df_covid19_100 |>
  ...
  config(toImageButtonOptions = list(format = 'svg', filename = 'D:/R/git/datavisualization/plotly/RnPy/chap2/R_svg/2-9'))
...
df_취업률_500 |>
  ...
  add_trace(type = 'scatter', mode = 'markers', 
            x = ~졸업자수, y = ~취업자수,
            hoverinfo = 'y') |>
  config(toImageButtonOptions = list(format = 'svg', filename = 'D:/R/git/datavisualization/plotly/RnPy/chap2/R_svg/2-10'))
...
df_취업률_500 |>
  ...
  config(toImageButtonOptions = list(format = 'svg', filename = 'D:/R/git/datavisualization/plotly/RnPy/chap2/R_svg/2-11'))
...
df_취업률_500 |> 
  ...
  config(toImageButtonOptions = list(format = 'svg', filename = 'D:/R/git/datavisualization/plotly/RnPy/chap2/R_svg/2-12'))
...
p1 <- df_취업률_500 |> plot_ly(x = ~졸업자수, y = ~취업자수, alpha = 0.3, color = I('#1f77b4'))

p2 <- df_취업률_500 |> plot_ly(x = ~졸업자수, y = ~취업자수, opacity = 0.3, color = I('#1f77b4'))
...
subplot(
  ...
  layout(margin = margins_R) |>
  config(toImageButtonOptions = list(format = 'svg', filename = 'D:/R/git/datavisualization/plotly/RnPy/chap2/R_svg/2-13'))
...
df_취업률_500 |> 
  ...
  add_trace(type = 'scatter', mode = 'markers', 
            ...
            ## showlegend을 FALSE로 설정
            showlegend = FALSE) |>
  config(toImageButtonOptions = list(format = 'svg', filename = 'D:/R/git/datavisualization/plotly/RnPy/chap2/R_svg/2-14'))
...
R_layout_scatter <- df_취업률_500 |> 
  ...
  config(toImageButtonOptions = list(format = 'svg', filename = 'D:/R/git/datavisualization/plotly/RnPy/chap2/R_svg/2-15'))
...
R_layout_scatter |> 
  layout(title = list(text = "<span style = 'font-size:15pt'><span style = 'color:red;font-weight:bold;'> 졸업자</span><span style = 'font-size:10pt'> 대비</span> <span style = 'color:blue;font-weight:bold;'>취업자</span></span>", 
                      x = 0.5, xanchor = 'center', yanchor = 'top')) |>
  config(toImageButtonOptions = list(format = 'svg', filename = 'D:/R/git/datavisualization/plotly/RnPy/chap2/R_svg/2-16'))
...
R_layout_scatter <- R_layout_scatter |> 
  ...
  config(toImageButtonOptions = list(format = 'svg', filename = 'D:/R/git/datavisualization/plotly/RnPy/chap2/R_svg/2-17'))
...
R_layout_scatter <- R_layout_scatter |>
  ...
  config(toImageButtonOptions = list(format = 'svg', filename = 'D:/R/git/datavisualization/plotly/RnPy/chap2/R_svg/2-18'))
...
R_layout_scatter <- R_layout_scatter |> 
  ...
  config(toImageButtonOptions = list(format = 'svg', filename = 'D:/R/git/datavisualization/plotly/RnPy/chap2/R_svg/2-19'))
...
R_layout_scatter |>
  layout(xaxis = list(range = c(0, 350), rangemode = 'nonnegative'),
         ...
         margin = list(pad = 5)) |>
  config(toImageButtonOptions = list(format = 'svg', filename = 'D:/R/git/datavisualization/plotly/RnPy/chap2/R_svg/2-20'))
...
R_layout_line <- R_layout_line |> 
  ...
  config(toImageButtonOptions = list(format = 'svg', filename = 'D:/R/git/datavisualization/plotly/RnPy/chap2/R_svg/2-21'))
R_layout_line
...
R_layout_line <- R_layout_line |> 
  ...
  config(toImageButtonOptions = list(format = 'svg', filename = 'D:/R/git/datavisualization/plotly/RnPy/chap2/R_svg/2-22'))
...
R_layout_scatter |> 
  ...
  config(toImageButtonOptions = list(format = 'svg', filename = 'D:/R/git/datavisualization/plotly/RnPy/chap2/R_svg/2-23'))
...
R_layout_line <- R_layout_line |> 
  ...
  config(toImageButtonOptions = list(format = 'svg', filename = 'D:/R/git/datavisualization/plotly/RnPy/chap2/R_svg/2-24'))
...
subplot(p1_blue, p2_blue, p3_blue, p4_blue, p5_blue, p6_blue, p7_blue, nrows = 3) |>
  ...
  config(toImageButtonOptions = list(format = 'svg', filename = 'D:/R/git/datavisualization/plotly/RnPy/chap2/R_svg/2-25'))
...
subplots_blue <- df_covid19_100 |>
  ...
  layout(showlegend = TRUE, 
         title = '최근 100일간 코로나19 확진자수',
         margin = margins_R) |>
  config(toImageButtonOptions = list(format = 'svg', filename = 'D:/R/git/datavisualization/plotly/RnPy/chap2/R_svg/2-26'))
...
subplots_blue |> 
  ...
  config(toImageButtonOptions = list(format = 'svg', filename = 'D:/R/git/datavisualization/plotly/RnPy/chap2/R_svg/2-27'))
...
subplot(
  ...
  layout(showlegend = TRUE,
         ...
         ## 전체 여백 설정
         margin = margins_R) |>
  config(toImageButtonOptions = list(format = 'svg', filename = 'D:/R/git/datavisualization/plotly/RnPy/chap2/R_svg/2-28'))
...
subplot(
  ...
  layout(showlegend = TRUE,
         ...
         ## 전체 여백 설정
         margin = margins_R) |>
  config(toImageButtonOptions = list(format = 'svg', filename = 'D:/R/git/datavisualization/plotly/RnPy/chap2/R_svg/2-29'))
...
subplot(
  ...
  layout(showlegend = TRUE, 
         title = '최근 100일간 코로나19 확진자수',
         margin = margins_R) |>
  config(toImageButtonOptions = list(format = 'svg', filename = 'D:/R/git/datavisualization/plotly/RnPy/chap2/R_svg/2-30'))
...
ggplotly(ggplotly) |>
  config(toImageButtonOptions = list(format = 'svg', filename = 'D:/R/git/datavisualization/plotly/RnPy/chap2/R_svg/2-31'))
