...
fig.add_trace(go.Choropleth(
  geojson=geometry, featureidkey='properties.CTPRVN_CD', 
  locations = df_충원율['지역코드'], z = df_충원율['신입생충원율'], 
  colorscale="Blues", 
#  text = df_충원율['신입생충원율'],
...
![실행결과 VI-5. python의 단계구분도](./fig/png/6-5.png)
...
plot_mapbox(plot_dat_seoul) |>
  ...
  add_trace(data = df_univ, type = 'scattermapbox', mode = 'markers+text', 
            x = ~lon, y = ~lat, cluster = list(enabled = TRUE),
            marker = list(color = 'blue', symbol = 'college', size = 10, allowoverlap = T),
